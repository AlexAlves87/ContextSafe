# LoRA Legal-XLM-RoBERTa NER - Évaluation Adversariale

**Date :** 06/02/2026
**Modèle :** lora_ner_v1 (Legal-XLM-RoBERTa-base + LoRA r=128)
**Tests :** 35
**Temps :** 1,2s

---

## 1. Comparaison avec les Baselines

| Modèle | F1 Strict | Précision | Rappel | Taux de Réussite | Delta |
|--------|-----------|-----------|--------|------------------|-------|
...
| Catégorie | Taux de Réussite | COR | MIS | SPU |
|-----------|------------------|-----|-----|-----|
| edge_case | 0% | 0 | 2 | 1 |
...
**Généré par :** `scripts/evaluate/evaluate_lora_ner_adversarial.py`
