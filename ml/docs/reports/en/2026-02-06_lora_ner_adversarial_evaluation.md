# LoRA Legal-XLM-RoBERTa NER - Adversarial Evaluation

**Date:** 2026-02-06
**Model:** lora_ner_v1 (Legal-XLM-RoBERTa-base + LoRA r=128)
**Tests:** 35
**Time:** 1.2s
...
| Model | F1 Strict | Precision | Recall | Pass Rate | Delta |
|-------|-----------|-----------|--------|-----------|-------|
...
| Category | Pass Rate | COR | MIS | SPU |
|----------|-----------|-----|-----|-----|
| edge_case | 0% | 0 | 2 | 1 |
