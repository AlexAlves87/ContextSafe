...
|--------|-------|-------------|
| COR | 52 | Correct (exact boundary + type) |
| INC | 1 | Correct boundary, incorrect type |
| PAR | 5 | Partial match (overlap) |
| MIS | 9 | Missing (FN) |
| SPU | 7 | Spurious (FP) |
...
| bank_account_clause | real | 1 | 1 | 1 | 0 | 0 | INC: 1 type mismatches; PAR: 1 partial m... |
