...
|--------|-------|-------------|
| COR | 28 | Correct (exact boundary + type) |
| INC | 0 | Correct boundary, incorrect type |
| PAR | 20 | Partial match (overlap) |
| MIS | 19 | Missing (FN) |
| SPU | 11 | Spurious (FP) |
...
|------|-----|-----|-----|-----|-----|-----|--------|
| very_long_name | edge | 0 | 0 | 1 | 0 | 0 | PAR: 1 partial match |
...
| social_security | real | 0 | 0 | 1 | 0 | 0 | PAR: 1 partial match |
