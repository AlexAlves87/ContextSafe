# LoRA Legal-XLM-RoBERTa NER - Avaliação Adversarial

**Data:** 06-02-2026
**Modelo:** lora_ner_v1 (Legal-XLM-RoBERTa-base + LoRA r=128)
**Testes:** 35
**Tempo:** 1.2s

---

## 1. Comparação com Baselines

| Modelo | F1 Strict | Precisão | Recall | Taxa de Aprovação | Delta |
|--------|-----------|----------|--------|-------------------|-------|
...
| Categoria | Taxa Aprovação | COR | MIS | SPU |
|-----------|----------------|-----|-----|-----|
| edge_case | 0% | 0 | 2 | 1 |
...
**Gerado por:** `scripts/evaluate/evaluate_lora_ner_adversarial.py`
