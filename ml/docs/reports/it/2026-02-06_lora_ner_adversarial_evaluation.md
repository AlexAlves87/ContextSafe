# LoRA Legal-XLM-RoBERTa NER - Valutazione Adversarial

**Data:** 06-02-2026
**Modello:** lora_ner_v1 (Legal-XLM-RoBERTa-base + LoRA r=128)
**Test:** 35
**Tempo:** 1.2s

---

## 1. Confronto con le Baseline

| Modello | F1 Strict | Precisione | Richiamo | Tasso di Superamento | Delta |
|---------|-----------|------------|----------|----------------------|-------|
...
| Categoria | Tasso Superamento | COR | MIS | SPU |
|-----------|------------------|-----|-----|-----|
| edge_case | 0% | 0 | 2 | 1 |
...
**Generato da:** `scripts/evaluate/evaluate_lora_ner_adversarial.py`
