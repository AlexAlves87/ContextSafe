...
|---------|--------|
| **F1 (strict)** | **0.545** |
| Precisione (strict) | 0.554 |
| Richiamo (strict) | 0.537 |
| F1 (parziale) | 0.705 |
...
| notarial_header | real | 3 | 0 | 1 | 0 | 0 | PAR: 1 corrispondenza parziale |
...
| bank_account_clause | real | 0 | 1 | 2 | 0 | 0 | INC: 1 tipo errato; PAR: 2 corrisp... |
