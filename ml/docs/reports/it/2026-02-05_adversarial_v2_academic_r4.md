...
|---------|--------|
| **F1 (strict)** | **0.543** |
| Precisione (strict) | 0.565 |
| Richiamo (strict) | 0.522 |
| F1 (parziale) | 0.690 |
...
|---------|--------|-------------|
| COR | 35 | Corretti (confine + tipo esatti) |
| INC | 1 | Confine corretto, tipo errato |
| PAR | 19 | Corrispondenza parziale (sovrapposizione) |
| MIS | 12 | Persi (FN) |
| SPU | 7 | Spuri (FP) |
| **POS** | 67 | Totale gold (COR+INC+PAR+MIS) |
| **ACT** | 62 | Totale sistema (COR+INC+PAR+SPU) |
