...
### 1.1 SemEval 2013 Metriken (Striker Modus)

| Metrik | Wert |
|--------|------|
| **F1 (strikt)** | **0,464** |
| Precision (strikt) | 0,500 |
| Recall (strikt) | 0,433 |
| F1 (partiell) | 0,632 |
...
| ocr_missing_spaces | ocr_ | 0 | 0 | 1 | 1 | 0 | MIS: ['12345678X']; PAR: 1 partielle... |
| ocr_extra_spaces | ocr_ | 0 | 0 | 0 | 2 | 0 | MIS: ['1 2 3 4 5 6 7 8 Z', 'M a r í a'] |
| cyrillic_o | unic | 1 | 0 | 1 | 0 | 0 | PAR: 1 partielle Match |
